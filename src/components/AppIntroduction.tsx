    ...
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      <section className="mb-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-fade-in opacity-90">
            Transform your logo workflow with our intelligent export system
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-card rounded-xl p-6 border shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground">
              Upload your logo once and automatically generate all the file formats and variations you need in seconds.
            </p>
          </div>
          ...
          <div className="bg-card rounded-xl p-6 border shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2">Color Variations</h3>
            <p className="text-muted-foreground">
              Generate black, white, and original color versions of your logo for all branding applications.
            </p>
          </div>
          ...
          <div className="bg-card rounded-xl p-6 border shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground">
              Receive a ZIP file with an organized folder structure containing all your logo assets.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="text-center">
        <h2 className="text-3xl font-bold mb-6">Ready to Streamline Your Logo Workflow?</h2>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
          Join thousands of designers and brand managers who save hours on logo preparation every week.
        </p>
        <Button onClick={() => navigate('/auth')} size="lg" className="gap-2">
